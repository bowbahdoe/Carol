...
/** BasicGUI is a graphical user interface for people wishing to program
 * the Personal Exploration Rover (PER). BasicGUI provides some basic
 * functionality, allowing programmers to design their own PER programs
 * without the need to design a graphical interface.
 *<p>
 * The BasicGUI interface already provides a way for people to specify an IP address,
 * connect to a rover, take and display pictures and panoramas, save images,
 * and view text output from the rover.
 *<p>
 * BasicGUI also contains ten command buttons. The programmer can specify
 ...
 * </code>
 *<p>
 * The above code sample illustrates two other useful functions in BasicGUI:
 ...
 * a string, BasicGUI provides convenience methods to allow you to
 ...
 *</pre></code>
 *<p>
 * One final feature of BasicGUI is the Stop button. If you use <code>executeAction</code>
...
public class BasicGUI extends JFrame {
     ...
     * <code>Log.println</code>. Lines printed to Rover.log from BasicGUI
    ...
    private void setDescriptions(){
        ...
        description1.setText("Do a dance until the Stop button is hit.");
    ...
    /** The task associated with button1. */
    private void command1(){
        //Add your code here:
        
        //sample - dance until told to stop
        TurnToAction turn = new TurnToAction(5);
        TurnToAction turnR = new TurnToAction(-5);
        DriveToAction drive = new DriveToAction(10);
        DriveToAction driveN = new DriveToAction(-10);
        CreepAction creep = new CreepAction(10,90,.4,true);
        CreepAction creepR = new CreepAction(10,-90,.4,true);
        
        while(!stop){
            executeAction(drive);
            executeAction(driveN);
            executeAction(turn);
            executeAction(turnR);
            executeAction(turn);
            executeAction(turnR);
            executeAction(creep);
            executeAction(creepR);
            executeAction(turn);
            executeAction(turnR);
        }
    }
    
    /** The task associated with button2. */
    private void command2(){
        //Add your code here:
        
    }
    
    /** The task associated with button3. */
